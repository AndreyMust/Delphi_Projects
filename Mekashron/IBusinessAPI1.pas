...
// WSDL     : C:\Tools\Delphi_Projects\Project_4\IBusinessAPI.xml
//  >Import : C:\Tools\Delphi_Projects\Project_4\IBusinessAPI.xml>0
//  >Import : C:\Tools\Delphi_Projects\Project_4\IBusinessAPI.xml>1
// (24.01.2023 13:32:40 - - $Rev: 93209 $)
// ************************************************************************ //
...
type
  ...
  ['{FC4260E4-8538-A2CD-8D30-5C86FF7E21B7}']
    ...
    function  Telemarketing_add(const ol_EntityID: Integer;
                                const ol_Username: string;
                                const ol_Password: string;
                                const campaignID: Integer;
                                const EntityIds: ArrayOfInt): string; stdcall;
...
const
  defWSDL = 'C:\Tools\Delphi_Projects\Project_4\IBusinessAPI.xml';
